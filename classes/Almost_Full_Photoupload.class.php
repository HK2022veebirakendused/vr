<?php
    class Photoupload {
        ...
        private function create_image_from_file($photo, $file_type){
            ...
            if($file_type == "jpg"){
                $temp_image = imagecreatefromjpeg($photo);
            }
            if($file_type == "png"){
                $temp_image = imagecreatefrompng($photo);
            }
            if($file_type == "gif"){
                $temp_image = imagecreatefromgif($photo);
            }
            return $temp_image;
        }
        ...
        public function add_watermark($watermark_file){
            ...
            $watermark_x = imagesx($this->new_temp_image) - $watermark_width - 10;
            $watermark_y = imagesy($this->new_temp_image) - $watermark_height - 10;
            imagecopy($this->new_temp_image, $watermark, $watermark_x, $watermark_y, 0, 0, $watermark_width, $watermark_height);
